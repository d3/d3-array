...
<a name="count" href="#count">#</a> d3.<b>count</b>(<i>iterable</i>[, <i>accessor</i>]) [<>](https://github.com/d3/d3-array/blob/master/src/count.js "Source")

Returns the number of valid number values (i.e. not null nor NaN) in the specified *iterable*; accepts an accessor.
